...
type Rates struct {
	...
	Rates       []float32   `json:"rates" gorm:"column:rates"`
	...
	Anonymous   bool        `json:"anonymous" gorm:"column:anonymous" bson:"anonymous,omitempty" dynamodbav:"anonymous,omitempty" firestore:"anonymous,omitempty"`
